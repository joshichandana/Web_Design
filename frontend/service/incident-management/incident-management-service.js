 ...
 * - Fetch api's for get All User , Get all Incidents , Update/Delete Incident
...
// Get All Users
export const getAllUserforIncident = async () =>  {
...
export const getCommonSort = (rows , filters) =>{
    ...
    switch(filters.type) {
        ...
        items = rows.sort((a,b) => { 
            ...
            sortOrder['priority'][b.priority] - sortOrder['priority'][a.priority] ;  //a-b  asc
        })
        break;
