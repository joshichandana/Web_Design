...
import { saveSelectedFilter } from '../../../store/slice/incidentManagementSlice';
...
function FilterScreen() {
     ...
     * Combination of filters will be return Incident Data
    ...
    let [dropDownValues, selectedFilters] = useSelector((state: any) => [
        { ...state.IncidentManagement.dropDownValues },
        {...state.IncidentManagement.selectedFilters},
...
// Apply filters will filter in Incident menu
    const submitChange = () => {
